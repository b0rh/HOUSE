...
# Usage docker-robofuzz_TB3.sh <timeout>
#     Examples:
#        1 hour: docker-robofuzz_TB3.sh 1h
#        30 minutes: docker-robofuzz_TB3.sh 30m
...
docker run --rm -it \
    ...
    --name RZ_TB3_${HS_TIMEOUT}_${HS_IDNUM} $ROBOFUZZ_img \
