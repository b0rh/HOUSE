...
# Run ROS2 demo listener with implementation rmw_cyclonedds_cpp
# Usage demo_Cyclone_listener.sh <timeout>
#     Examples:
#        1 hour: demo_Cyclone_listener.sh 1h
#        30 minutes: demo_Cyclone_listener.sh 30m
...
echo "+ [${HS_IDNUM}] Running Cyclone DDS listener for $HS_TIMEOUT +"
