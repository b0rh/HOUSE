...
# Run ROS2 demo listener with implementation rmw_fastrtps_cpp
# Usage demo_FastRTPS_listener.sh <timeout>
#     Examples:
#        1 hour: demo_FastRTPS_listener.sh 1h
#        30 minutes: demo_FastRTPS_listener.sh 30m
...
COMMAND="time ros2 run demo_nodes_cpp listener"
c_OUTPUT_FILEPATH="/log/$(basename $0)_${HS_TIMEOUT}_${HS_IDNUM}.pyout"

echo "+ [${HS_IDNUM}] Running FASTRTPS DDS listener for $HS_TIMEOUT +"
